...
- 一句话生成图示：AI planner 内置登录、注册、订单支付、客服工单、审批和项目发布等稳定流程图模板，真实模型开启时也优先使用模板保证演示质量
- 画布总结与优化建议：AI 可回答“现在画布里有什么”“帮我优化这个流程图”，结果以反馈和语音播报形式返回
